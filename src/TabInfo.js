...
export class tabInfo extends React.Component {
  ...
  getEnhancedComponent = () => {
    ...
    // get the props generated by babel-react-doc-gen
    ...
    /**
     * Enhance the component. This does is nothing more then add a wrapper with the right name and docInfo.
     * But is absolutely crucial for withInfo()
     */
