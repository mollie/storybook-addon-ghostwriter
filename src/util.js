...
export const hasDocgen = component =>
  (component.__docgenInfo && isNotEmpty(component.__docgenInfo.slice(-1)[0])) ||
...
export const getDocgenInfo = component =>
  isIntlInjected(component)
    ? component.WrappedComponent.__docgenInfo.slice(-1)[0]
    : component.__docgenInfo.slice(-1)[0];
